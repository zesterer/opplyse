...
#    - 0.14: install contracts
#    - XXX: NOT DONE! implement *.vala and *.c files
...
macro(prepare_elementary)
    ...
    if( NOT ARGS_VALA_FILES)
        ...
        #foreach( file files)
        #    set (ARGS_VALA_FILES ${ARGS_VALA_FILES} ${file})
        #endforeach()
        # include_directories (${ARGS_SOURCE_PATH})
        #set (VALA_GEN_DIR ${CMAKE_CURRENT_BINARY_DIR})
    endif()
    #message ("ARGS_VALA_FILES ${ARGS_VALA_FILES}")
    # If no file list is provided use the *.c files in ARGS_SOURCE_PATH
    # recursively
    #if( NOT ARGS_C_FILES)
    #    file (sources GLOB RECURSIVE src *.vala)
    #endif()
